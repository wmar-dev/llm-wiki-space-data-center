...
The economics hinge almost entirely on launch cost. The current consensus threshold for viability is **$100–200/kg to GEO** [[wiki/sources/space-based-solar-power.md]] [[wiki/sources/test-pdf.md]] *(industry_report)*. At today's rates (~$2,000/kg on Falcon Heavy [[wiki/sources/space-based-solar-power.md]] *(other)*), space data centers are not economically competitive. The path to viability is therefore contingent on SpaceX Starship achieving its $10–100/kg target [[wiki/sources/test-pdf.md]] *(industry_report)* — a range that would cross the threshold, but which has not yet been demonstrated at commercial scale.
...
Both structures must be launched and deployed, and both masses scale linearly with power [[wiki/concepts/thermal-management.md]] [[wiki/sources/test-pdf.md]] *(industry_report)*. Until launch costs fall dramatically, the capital expenditure per MW is orders of magnitude higher than terrestrial alternatives.
...
The entire financial case depends on Starship achieving $10–100/kg. If costs land at $500/kg instead, the economics remain prohibitive. [[wiki/sources/test-pdf.md]] *(industry_report)*
...
LEO eclipse periods run up to 36 minutes per 90-minute orbit, requiring battery or fuel cell storage for uninterrupted operation [[wiki/sources/test-pdf.md]] *(industry_report)*. Storage adds mass, cost, and failure modes — and systems that cycle multiple times per day degrade faster than terrestrial equivalents.
